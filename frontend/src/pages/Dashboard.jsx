...
function SettingsPanel({ settings: initSettings, onSaveSettings }) {
  ...
  const [vals, setVals] = useState({
    speed_threshold: initSettings?.speed_threshold || '0.1',
    ...
    <div className="card settings-card">
      ...
      <div className="s-body">
        {tab === 'detection' && <>
          ...
          <Slider label="Speed Threshold (Complete Stop)" value={vals.speed_threshold} min={0} max={2} step={0.01} unit="m/s" onChange={sl('speed_threshold')} desc="Maximum speed considered as stopped" />
